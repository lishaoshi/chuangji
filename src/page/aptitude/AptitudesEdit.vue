<template>
    <div id="AptitudesEdit" style="min-height: 100%">
        ...
        <form>
            ...
            <ul class="edit-ul">
                <li class="choice-icon" v-if="userType === 3" @click="showRolePicker"><span>公司类型</span><div>{{companyTypeName}}</div></li>
                <li class="choice-icon" v-else style="background: none"><span>公司类型</span><div>{{companyType}}</div></li>
                <li><span>公司名称1</span><input type="text" name="companyName" v-model="companyName" placeholder="请填写公司名称" style="font-size: .28rem"></li>
            </ul>
            <!--
