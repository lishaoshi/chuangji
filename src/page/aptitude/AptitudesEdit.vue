<template>
    <div id="AptitudesEdit" style="min-height: 100%">
        ...
        <form>
            ...
            <ul class="edit-ul">
                <li class="choice-icon" v-if="userType === 3" @click="showRolePicker"><label>公司类型1</label><div>{{companyTypeName}}</div></li>
                <li class="choice-icon" v-else style="background: none"><label>公司类型</label><div>{{companyType}}</div></li>
