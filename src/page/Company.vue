<template>
    <PullRefresh @refresh="refresh">
        ...
        <page-edit-aptitude v-else-if="CERT_STATUS === 0 || CERT_STATUS===4" :sub_type_name="sub_type_name" :sub_type="sub_type" :userType="USER_TYPE" :imgList="imgList" :isEdit="true" :certStatus="CERT_STATUS" :org_name="org_name"/>
