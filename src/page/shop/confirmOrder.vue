        ...
        <section v-if="!showLoading">
            ...
            <router-link :to='{path: "/confirmOrder/chooseAddress", query: {id: checkoutData.cart.id, sig: checkoutData.sig}}' class="address_container">
                <div class="address_empty_left">
                    ...
                    <div class="add_address" v-if="!choosedAddress" style="color: #333;">请添加一个收货地址</div>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...mapMutations([
                'SAVE_GEOHASH', 'CHOOSE_ADDRESS', 'NEED_VALIDATION', 'SAVE_CART_ID_SIG', 'SAVE_ORDER_PARAM', 'ORDER_SUCCESS', 'SAVE_SHOPID'
            ]),
            //初始化数据
            async initData(){
                let ids = []
                if(this.shopId){
                    ids = Object.keys(this.cartList[this.shopId])
                }else{
